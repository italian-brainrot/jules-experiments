...
# Save the dataset
np.savez('cg_curve_prediction/logistic_regression_dataset.npz', X=X, y=y)

print("Dataset generated and saved to 'cg_curve_prediction/logistic_regression_dataset.npz'")
